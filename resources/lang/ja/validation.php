...
return [
    ...
    */
    ...
    'chiban' => ':attributeは半角数字または“-”のみで入力してください。',
    'decimal_digits' => ':attributeは:decimal_digits形式で指定してください。',
    'date_multi_format' => ':attributeは:date_multi_format形式で指定してください。',
    ...
    */
    ...
    'custom' => [
        ...
        'import'  => [
            ...
            'no_company_code' => '企業コードが存在していません。'
        ],
    ],
    ...
    */
    ...
    'attributes' => [
        ...
        'npassword' => '新規パスワード',
        'npassword_confirmation' => '新規パスワード（確認用）',
        'birthday' => '生年月日',
        'avatar_image' => 'プロフィール画像',
        'email' => 'メールアドレス',
        'first_name' => '氏名（姓）',
        'last_name' => '氏名（名）',
        'first_name_kana' => '氏名（フリガナ）（姓）',
        'last_name_kana' => '氏名（フリガナ）（名）',
        'gender' => '性別',
        'nick_name' => 'ニックネーム',
        'description' => '備考',
    ],
